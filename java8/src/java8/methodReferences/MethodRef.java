...
public class MethodRef {
	...
	public MethodRef() {
		...
		System.out.println(biop.apply(em1.getSal(), em2.getSal()));
		
		DoubleBinaryOperator biopone = this::add;
		System.out.println(biopone.applyAsDouble(em1.getSal(), em2.getSal()));
	}
